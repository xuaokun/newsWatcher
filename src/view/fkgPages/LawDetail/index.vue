<template>
    <div>
        ...
        <div class="row">
            <div class="col-lg-2">
                <AsideMenu v-on:gotoItem="ToItem" v-if="articleMenu" :menuData="articleMenu" />
            </div>
            <div class="col-lg-10">
                <div class="row">
                    <div class="col-lg-7">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-column mr-2 py-2" v-if="lawInfo[0]">
                                        <a href="#"
                                            class="text-dark text-hover-primary font-weight-bold font-size-h4 mr-3">{{lawInfo[0].title}}</a>
                                        <div class="d-flex align-items-center py-1">
                                            <a href="#"
                                                class="d-flex align-items-center text-muted text-hover-primary mr-2"
                                                v-if="lawInfo[0].status">
                                                <span
                                                    class="fa fa-genderless text-danger icon-md mr-2"></span>{{lawInfo[0].status}}</a>
                                            <a href="#" class="d-flex align-items-center text-muted text-hover-primary"
                                                v-if="lawInfo[0].release_date">
                                                <span
                                                    class="fa fa-genderless text-success icon-md mr-2"></span>{{lawInfo[0].release_date
                                                | formatDate}}颁布</a>
                                            <a href="#" class="d-flex align-items-center text-muted text-hover-primary"
                                                v-if="lawInfo[0].date">
                                                <span
                                                    class="fa fa-genderless text-success icon-md mr-2"></span>{{lawInfo[0].date
                                                | formatDate}}生效</a>
                                        </div>
                                    </div>
                                    <!--end::Title-->
                                ...
                                <div class="mb-3" v-if="lawInfo[0] && lawInfo[0].summary">
                                    ...
                                    <div class="cursor-pointer shadow-xs toggle-on" data-inbox="message">
                                        ...
                                        <div class="card-spacer-x pt-2 pb-5 toggle-off-item">
                                            <!--begin::Text-->
                                            <div class="mb-1">
                                                <p v-for="(item,index) in lawInfo[0].summary" :key="index">
                                                    {{item}}
                                                </p>
                                            </div>
                                            <!--end::Text-->
                                        ...
                                        <div class="d-flex align-items-start card-spacer-x py-4">
                                            ...
                                            <div class="d-flex flex-column flex-grow-1 flex-wrap mr-2">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div class="text-muted font-weight-bold toggle-on-item"
                                                        ...
                                                        Mr.Zinsser.
                                                        We all know the most part of important part....</div>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex align-items-center" data-inbox="toolbar">
                                                    ...
                                                    <span class="btn btn-clean btn-xs btn-icon" data-toggle="tooltip"
                        ...
                        <div class="card card-custom">
                            ...
                            <div class="card-body py-4">
                                ...
                                <div class="form-group row my-2" v-if="lawInfo[0] && lawInfo[0].file_type">
                                    ...
                                    <div class="col-8">
                                        <span
                                            class="form-control-plaintext font-weight-bolder">{{lawInfo[0].file_type}}</span>
                                    </div>
                                </div>
                                <div class="form-group row my-2" v-if="lawInfo[0] && lawInfo[0].dispatch_units">
                                    <label class="col-4 col-form-label">发文单位</label>
                                    <div class="col-8">
                                        <span
                                            class="form-control-plaintext font-weight-bolder">{{lawInfo[0].dispatch_units}}</span>
                                    </div>
                                </div>
                            </div>
                            <!--end::Body-->
                                ...
                                <div class="timeline timeline-6 mt-3">
                                    ...
                                    <div class="timeline-item align-items-start">
                                        ...
                                        <div class="font-weight-mormal font-size-lg timeline-content text-muted pl-3">
                                            第十二届全国人民代表大会常务委员会第十四次会议《关于修改〈中华人民共和国计量法〉等五部法律的决定》第三次修正）</div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    ...
                                    <div class="timeline-item align-items-start">
                                        ...
                                        <div class="timeline-content font-weight-mormal font-size-lg text-muted pl-3">
                                            第八届全国人民代表大会常务委员会第十四次会议通过颁布</div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Item-->
                                </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            articleMenu: function () {
                ...
                for (let item of this.lawInfo) {
                    if (item.index_f && item.index_f != preChapter) {//为新章节的第一条
                        if (preChapter != '#') {
                            let obj = {};
        ...
        props: ['lawId'],
        created() {
            this.axios.post("/api/sykg/query/law_infos/infos", { "sourceID": this.lawId })
                .then((data) => {
