<template>
    <div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <AsideMenu :menuData="menuDataList" v-on:gotoItem="searchByMenuSelect" />
            </div>
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12 res-list">
                        <PublishList :dataList="resultLawInfoList" :pageLength="pageLength" tableTitle="查询结果"
                            v-on:getPageData="getPageData" :tableHead="tableHead"></PublishList>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            async searchByCondition(params) {
                ...
                this.params = params;
                if (params) {
                    let res = await this.axios.post('/api/sykg/query/law_infos/keywords', params)
                    console.log(res)
