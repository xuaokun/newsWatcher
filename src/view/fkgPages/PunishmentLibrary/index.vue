<template>
  <div>
    <div class="row">
      <div class="col-lg-6">
        <pieChart v-show="punishTypePieData.nameList" title="处罚类型" :dataObj="punishTypePieData"/>
      </div>
      <div class="col-lg-6">
    ...
    <div class="row">
      <div class="col-lg-12">
        <PublishList tableTitle="最新处罚文件" :tableHead="tableHead" :dataList="recentPunishment"></PublishList>
      </div>
    </div>
  </div>
</template>
    ...
    methods: {
      getPunishData() {
        ...
        this.axios.post('/api/sykg/query/common/mongostats', { "IDs": [], "statsProperty": "punishedOrgan.type", "dbName": "punish_infos" })
          ...
          this.axios.post("/api/sykg/query/punish_infos/rencently", {companyName: ''})
            .then((data) => {
