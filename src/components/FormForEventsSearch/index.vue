        ...
        <form>
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        <input class="form-control" type="text" placeholder="以空格隔开多个关键词"
                            v-model="title" />
                    </div>
                    <label class="col-1 col-form-label">全文检索</label>
                    <div class="col-3">
                        <input class="form-control" type="search" placeholder="以空格隔开多个关键词"
                        v-model="content" />
                    </div>
                    <label class="col-1 col-form-label">相关对象</label>
                    <div class="col-3">
                        <input class="form-control" type="email" placeholder="公司名称/代码/人名"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        <input class="form-control" type="email" placeholder="风险类型"
                            v-model="risk_type"/>
                    </div>
                    <!-- <div class="col-1"></div> -->
            ...
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-9">
                        <button type="reset" class="btn btn-success mr-2" @click="submitSearch">检索</button>
    ...
    export default {
        ...
        methods: {
            submitSearch() {
                ...
                console.log(title_include, content_include, org_include, public_start, public_end);
                let time_cond = {};
                if(public_start){
                ...
                let params = {"ID":"","startTime":time_cond,"endTime":{},"or":{"content":content_include,"title":title_include},"and":{"subject":org_include}}
                // console.log(params);
