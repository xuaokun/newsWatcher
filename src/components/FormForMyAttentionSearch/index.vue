        ...
        <form>
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-1 col-form-label">企业名称</label>
                    <div class="col-3">
                        <input class="form-control" type="text" placeholder="公司名称或者简称" v-model="title_include" />
                    </div>
                    <label class="col-1 col-form-label">统一社会信用代码</label>
                    <div class="col-3">
                        <input class="form-control" type="search" placeholder="代码" v-model="content_include" />
                    </div>
                    <label class="col-1 col-form-label">法人名称</label>
                    <div class="col-3">
                        <input class="form-control" type="email" placeholder="法人" v-model="org_include" />
                    </div>
                </div>
            </div>
            <div class="card-footer">
                <div class="row">
                    ...
                    <div class="col-9">
                        <button type="reset" class="btn btn-success mr-2">检索</button>
...
<script>
    export default {
        name: 'FormForMyAttentionSearch',
        data() {
            return {
                public_start: '2011-08-19T13:45:00',
                public_end: '2011-08-19T13:45:00',
                decision_start: '2011-08-19T13:45:00',
                decision_end: '2011-08-19T13:45:00',
                title_include: '',
                content_include: '',
                org_include: '',
            }
