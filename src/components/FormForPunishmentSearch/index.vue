        ...
        <form>
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        <input class="form-control" type="text" placeholder="以空格隔开多个关键词" v-model="title_include" />
                    </div>
                    <label class="col-1 col-form-label">全文检索</label>
                    <div class="col-3">
                        <input class="form-control" type="search" placeholder="以空格隔开多个关键词" v-model="content_include" />
                    </div>
    ...
    export default {
        ...
        methods: {
            submitSearch() {
                ...
                let params = { "decOrgName": [], "decisionTime": dec_time_cond, "pubTime": pub_time_cond, "or": { "content": content_include, "title": title_include }, "and": { "punishedOrg": org_include } }
                console.log(params);
