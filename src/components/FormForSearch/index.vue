        ...
        <div class="form-group row">
          ...
          <div class="col-3">
            <input
              ...
              id="title_word_include_all"
              v-model="title_word_include_all"
            />
          </div>
          ...
          <div class="col-3">
            <input
              class="form-control"
              type="search"
              placeholder="包含以下任一关键词（以空格区分）"
              id="title_word_include_one"
              v-model="title_word_include_one"
            />
          </div>
          <label class="col-1 col-form-label"></label>
          <div class="col-3">
            <input
              class="form-control"
              type="email"
              placeholder="不包含以下任一关键词（以空格区分）"
              id="title_word_not_include"
              v-model="title_word_not_include"
            />
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-3">
            <input
              ...
              type="text"
              placeholder="包含以下全部关键词（以空格区分）"
              id="content_word_include_all"
              v-model="content_word_include_all"
            />
          </div>
          <label class="col-1 col-form-label"></label>
          <div class="col-3">
            <input
              ...
              type="search"
              placeholder="包含以下任一关键词（以空格区分）"
              id="content_word_include_one"
              v-model="content_word_include_one"
            />
          </div>
          <label class="col-1 col-form-label"></label>
          <div class="col-3">
            <input
              ...
              type="email"
              placeholder="不包含以下任一关键词（以空格区分）"
              id="content_word_not_include"
              v-model="content_word_not_include"
            />
          </div>
        </div>
...
export default {
  ...
  methods: {
    submitSearch() {
      let title_word_include_all_list = this.title_word_include_all
        ? this.title_word_include_all.split(" ")
        : [];
      let title_word_include_one_list = this.title_word_include_one
        ? this.title_word_include_one.split(" ")
        : [];
      let title_word_not_include_list = this.title_word_not_include
        ? this.title_word_not_include.split(" ")
        : [];
      let content_word_include_all_list = this.content_word_include_all
        ? this.content_word_include_all.split(" ")
        : [];
      let content_word_include_one_list = this.content_word_include_one
        ? this.content_word_include_one.split(" ")
        : [];
      let content_word_not_include_list = this.content_word_not_include
        ? this.content_word_not_include.split(" ")
        : [];
      let public_start = this.publish_start
        ? this.publish_start + " 00:00:00"
        : null;
      let public_end = this.publish_end ? this.publish_end + " 00:00:00" : null;
      let effetive_start = this.effective_start
        ? this.effective_start + " 00:00:00"
        : null;
      let effetive_end = this.effective_end
        ? this.effective_end + " 00:00:00"
        : null;
      console.log(public_start, public_end, effetive_start, effetive_end);
      let publish_department = this.publish_department
        ? this.publish_department
        : "";
      console.log(publish_department);
      let action_time_cond = {},
        pub_time_cond = {};
      if (effetive_start) {
